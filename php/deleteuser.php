...
<header>
    <div class="menu">
        ...
        <div class="container">
            <form id="contact" action="userdelete.php" method="POST">
                <h3>Eliminar lote</h3>
                <fieldset>
                    <input placeholder="Id del usuario a eliminar" min="1" pattern="^[0-9]+" type="number" name="id" tabindex="1" required
                        autofocus>
                </fieldset>
                <fieldset>
